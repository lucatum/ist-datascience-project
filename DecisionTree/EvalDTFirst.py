...
tight_layout()
savefig(f"images/Eval/DT/Set 1 – Covid/{file_tag}_dt_{eval_metric}_study.png", dpi=300)
show()
# %%
...
tight_layout()
savefig(
    f'images/Eval/DT/Set 1 – Covid/{file_tag}_dt_{params["name"]}_best_{params["metric"]}_eval.png',
    dpi=300,
)
show()
...
tree_filename: str = (
    f"images/Eval/DT/Set 1 – Covid/{file_tag}_dt_{eval_metric}_best_tree"
)
max_depth2show = 3
...
tight_layout()
savefig(
    f"images/Eval/DT/Set 1 – Covid/{file_tag}_dt_{eval_metric}_vars_ranking.png",
    dpi=300,
)
...
tight_layout()
savefig(
    f"images/Eval/DT/Set 1 – Covid/{file_tag}_dt_{eval_metric}_overfitting.png", dpi=300
)
