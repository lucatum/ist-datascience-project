...
savefig(f"images/Eval/MLP/Set 2 – Credit/{file_tag}_mlp_{eval_metric}_study.png")
show()
...
savefig(
    f'images/Eval/MLP/Set 2 – Credit/{file_tag}_mlp_{params["name"]}_best_{params["metric"]}_eval.png'
)
show()
# %% OVERFITTING
...
savefig(f"images/Eval/MLP/Set 2 – Credit/{file_tag}_mlp_{eval_metric}_overfitting.png")
